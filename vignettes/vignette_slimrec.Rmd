...
temp <- slim(mat           = ft_implicit # input sparse ratings matrix
             ...
             , nproc       = 4           # number of concurrent processes
...
If you intend to use SLIM method for large matrices( around >= 1e7 ratings), this package might be slow enough to be practically useful even in parallel mode. You might want to look at [biglasso](https://cran.r-project.org/web/packages/biglasso) and other implementations like JAVA based [librec](http://www.librec.net/).